...
STATIC FUNCTION CreateChildWindow()
   ...
   PREPARE FONT oFontBtn ;
      NAME "MS Sans Serif" ;
      WIDTH 0 ;
      HEIGHT -12

   INIT WINDOW oChildWnd ;
      MDICHILD ;
      TITLE "Child" ;
   ...
   @ 2, 3 OWNERBUTTON oBoton1 ;
      OF oPanel ;
      ID 108 ;
      ON CLICK { || oBoton2:Enable() } ;
       SIZE 44, 38 FLAT ;
       TEXT "New" ;
   ...
   @ 20, 190  BUTTON "Ok" ;
      SIZE 100, 32 ;
      ON CLICK { ||( hwg_Msginfo( e1 + chr(10) + chr(13) + ;
   ...
   @ 180, 190 BUTTON "Cancel" ;
      SIZE 100, 32 ;
      ON CLICK { || oChildWnd:Close() }
...
STATIC FUNCTION NoExit()
   ...
   INIT DIALOG oDlg ;
      TITLE "No Exit Enter and Esc"     ;
      AT 190, 10 ;
      SIZE 360, 240 ;
      NOEXIT ;
      NOEXITESC

   @ 10, 10 GET oGet VAR vGET ;
      SIZE 200, 32
...
// Local aTabs := { "Monday","Tuesday","Wednesday","Thursday","Friday" }
   ...
   @ 20, 70 CHECKBOX "Check 1" ;
      SIZE 90, 20

   @ 20, 95 CHECKBOX "Check 2"  ;
        SIZE 90, 20 ;
        COLOR Iif( nColor == Nil, hwg_ColorC2N( "0000FF" ), nColor )

   @ 160, 70 GROUPBOX "RadioGroup"  ;
      SIZE 130, 75
   ...
   @ 180, 90 RADIOBUTTON "Radio 1"  ;
        SIZE 90, 20 ;
        ON CLICK { || oEdit:SetColor( hwg_ColorC2N( "0000FF" ),,.T. ) }

   @ 180,115 RADIOBUTTON "Radio 2" ;
        SIZE 90, 20 ;
        ON CLICK { || oEdit:SetColor( hwg_ColorC2N( "FF0000" ),, .T. ) }

   END RADIOGROUP SELECTED 2

   @ 20, 120 COMBOBOX aCombo ;
      STYLE WS_TABSTOP ;
      SIZE 100, 150 ;
      EDIT
...
STATIC FUNCTION TestTab()
   ...
   BEGIN PAGE "Page 01" of oTab
      ...
      @ 30, 90 Get oGet2 VAR oVar2 ;
         SIZE 100, 26

      @ 30,120 Get oGet3 VAR oVar3 ;
         SIZE 100, 26

      @ 30,150 Get oGet4 VAR oVar4 ;
         SIZE 100, 26
